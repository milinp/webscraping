...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DummyVisited.modifiedTime'
        db.alter_column(u'scraper_dummyvisited', 'modifiedTime', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'DummyVisited.modifiedTime'
        db.alter_column(u'scraper_dummyvisited', 'modifiedTime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
